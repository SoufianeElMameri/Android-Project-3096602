package com.griffith.stepquest.utils
...
object IconsMapping {
    ...
    val medalIcons = mapOf(
        "Bronze" to R.drawable.bronze_medal,
        "Silver" to R.drawable.silver_medal,
        "Gold" to R.drawable.gold_medal,
    )

    val rankIcons = mapOf(
        "Bronze" to R.drawable.bronze_rank,
        "Silver" to R.drawable.silver_rank,
        "Gold" to R.drawable.gold_rank,
